...
export default function ChatFab() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-50 from-blue-500 to-teal-400 hover:from-blue-600 hover:to-teal-500 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg transition-all border-4 border-white"
