...
export default function Dashboard() {
  ...
  return (
    <div className="p-1 max-w-7xl mx-auto" dir="rtl">
      <div className="flex justify-between items-center mb-1">
        <h1 className="text-3xl font-bold text-gray-800">مسابقاتي</h1>
        <Button onClick={handleCreateNew} className="gap-1 bg-blue-600 hover:bg-blue-700">
          <Plus size={18} /> إنشاء مسابقة جديدة
        </Button>
      </div>

      {loading ? (
        <div className="text-center py-1 text-gray-500">جاري التحميل...</div>
      ) : (
