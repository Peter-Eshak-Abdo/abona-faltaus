      ...
      <main className="w-full max-w-8xl p-1 rounded-2xl backdrop-blur-md bg-white/6 border border-white/10 shadow-2xl">
        ...
        <section className="space-y-1 text-right leading-relaxed">
          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            ...
            <p className="mt-1">بمجرد دخولك واستخدامك لموقع {SITE_URL}، فأنك تقر بالتزامك الكامل بهذه الشروط. لو مش موافق على أي بند، يفضل عدم استخدام الموقع.</p>
          </article>

          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            <h2 className="font-semibold text-lg">٢. وصف الخدمة</h2>
            <p className="mt-1">موقع "ابونا فلتاؤس" هو منصة لتقديم محتوى روحي، سير قديسين، طلبات صلاة، وترانيم. الخدمة مقدمة "كما هي" وبنحاول دايماً نحدث المحتوى ونحافظ على دقته.</p>
          </article>
          ...
          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            ...
            <p className="mt-1">عند استخدام الموقع، يرجى الالتزام بما يلي:</p>
            <ul className="list-disc mr-1 mt-1">
          ...
          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            ...
            <p className="mt-1">الموقع قد يحتوي على روابط لمواقع تانية (مثل فيديوهات يوتيوب أو مصادر خارجية). إحنا مش مسؤولين عن محتوى أو سياسات المواقع دي، واستخدامك ليها بيبقى على مسؤوليتك الشخصية.</p>
          </article>

          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            <h2 className="font-semibold text-lg">٦. إخلاء المسؤولية</h2>
            <p className="mt-1">بنحاول بكل جهدنا إن الموقع يفضل شغال بدون أعطال، لكننا مش بنضمن عدم حدوث انقطاع تقني أو أخطاء غير مقصودة. الموقع غير مسؤول عن أي أضرار ناتجة عن استخدام الخدمة.</p>
          </article>

          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            <h2 className="font-semibold text-lg">٧. التعديلات على الشروط</h2>
            <p className="mt-1">ممكن نعدل شروط الخدمة دي في أي وقت. التعديلات بتبدأ من لحظة نشرها على الصفحة دي. استمرارك في استخدام الموقع معناه إنك موافق على الشروط الجديدة.</p>
          </article>

          <article className="p-1 rounded-xl bg-white/3 border border-white/6">
            <h2 className="font-semibold text-lg">٨. التواصل معنا</h2>
            <p className="mt-1">لو عندك أي استفسار بخصوص شروط الخدمة، تقدر تراسلنا:</p>
