    ...
    <>
      ...
      <main className="container pt-4 mt-5">
        <div className="d-flex flex-column justify-content-center align-items-center pt-5 mt-4">
          ...
          <p className="fs-2 text-secondry text-center fw-light mt-5">قسم العظات الارثوذكسية المسيحية</p>
          <img src="./images/sec1.jpeg" alt="قسم العظات" className="img-thumbnail rounded" width={750} height={500} sizes="(max-width: 768px) 90vw" />
        </div>
                ...
                <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                    <div className="accordion-item">
                      ...
                      <div id="collapseAlsla" className="accordion-collapse collapse" data-bs-parent="#accordionExample1">
                        <div className="accordion-body">
                    ...
                    <div className="accordion-item">
                      ...
                      <div id="collapseAltoba" className="accordion-collapse collapse" data-bs-parent="#accordionExample1">
                        <div className="accordion-body">
