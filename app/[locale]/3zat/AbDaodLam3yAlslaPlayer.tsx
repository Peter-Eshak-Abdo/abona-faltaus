...
const AbDaodLam3yAlslaPlayer: React.FC = () => {
  return (
    <div id="sec-abDaodLam3y-alsla" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
      {sounds
        .filter((sound) => sound.monasba === "abDaodLam3y-alsla")
        .map((sound, index) => (
          <Card key={`abDaodLam3y-alsla-${index}`} className="shadow-sm pt-3 ps-3">
            <CardContent>
