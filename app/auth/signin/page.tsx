        ...
        <Card className="shadow-xl border-amber-900/10 rounded-2xl overflow-hidden bg-white dark:bg-zinc-900">
          ...
          <CardContent className="space-y-4 p-5">
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-amber-700 hover:bg-amber-800 text-white rounded-xl font-bold py-2.5 h-11 text-sm shadow-md transition disabled:opacity-50 flex items-center justify-center gap-2"
                disabled={loading}
              >
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-xs"><span className="px-2 bg-white dark:bg-zinc-900 text-stone-500 font-medium">أو</span></div>
            </div>
            ...
            <Button
              ...
              className="w-full border-stone-200 dark:border-zinc-700 text-stone-700 dark:text-zinc-200 hover:bg-stone-50 dark:hover:bg-zinc-800 rounded-xl flex gap-2 items-center justify-center h-11 text-sm font-semibold transition"
            >
              {googleLoading ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
                <svg className="w-4 h-4" viewBox="0 -2 28 28">
            ...
            <p className="text-center text-xs sm:text-sm text-stone-600 dark:text-zinc-400 font-medium pt-2 border-t border-stone-100 dark:border-zinc-800">
              ليس لديك حساب؟{" "}
              <Link href="/auth/signup" className="text-amber-700 dark:text-amber-500 hover:underline font-bold">
                أنشئ حساب جديد
              </Link>
            </p>
          </CardContent>
