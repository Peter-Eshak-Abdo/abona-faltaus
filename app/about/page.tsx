      ...
      <div className="w-full max-w-8xl space-y-1 backdrop-blur-md bg-white/10 dark:bg-black/10 rounded-2xl shadow-2xl">
        ...
        <Card className="backdrop-blur-md bg-white/20 dark:bg-black/20 shadow-xl/30 inset-shadow-sm">
          ...
          <CardContent className="space-y-1">
            <div className="grid md:grid-cols-2 gap-1">
              <div>
                <h3 className="font-semibold mb-1 text-black">كنيسة السيدة العذراء مريم بالاسماعيلية</h3>
            ...
            <div className="text-center space-y-1">
              ...
              <div className="flex justify-center flex-col md:flex-row gap-1">
                <Button variant="outline" size="normal" className="bg-white/30 hover:bg-white/40 border-white/40 text-black font-semibold" asChild>
                  <a href={`mailto:${gmail}`} className="flex items-center gap-1">
                ...
                <Button variant="outline" size="normal" className="bg-white/30 hover:bg-white/40 border-white/40 text-black font-semibold" asChild>
                  <a href={portfolio} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
                    <ExternalLink className="w-4 h-4" />
                    عرض البورتفوليو
                  </a>
                </Button>
        ...
        <div className="text-center pt-2 pb-1">
          ...
          <div className="flex justify-center gap-1 text-sm text-black/80">
            <Button onClick={() => router.push(`/privacy`)} className="hover:text-black transition-colors">سياسة الخصوصية</Button>
            <Button onClick={() => router.push(`/terms`)} className="hover:text-black transition-colors">الشروط والأحكام</Button>
          </div>
        </div>
      </div>
    </div>
