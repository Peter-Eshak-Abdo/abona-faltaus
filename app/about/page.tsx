...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br flex items-center justify-center">
      <div className="w-full max-w-4xl space-y-3 backdrop-blur-md bg-white/10 dark:bg-black/10 rounded-2xl shadow-2xl">
        {/* Header */}
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-white drop-shadow-lg">أبونا فلتاؤس السرياني</h1>
          <p className="text-xl text-white/90 drop-shadow-md">تطبيق تفاحة - كنيسة السيدة العذراء مريم بالاسماعيلية</p>
          <Badge variant="secondary" className="text-sm bg-white/30 text-black border-white/40">
            نسخة تجريبية {APP_VERSION}
          </Badge>
        </div>

        {/* Mission */}
        <Card className="backdrop-blur-md bg-white/20 dark:bg-black/20 shadow-lg">
          <CardHeader>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">الحان والترانيم</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">الكتاب المقدس</h3>
                    <p className="text-sm text-white/80">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">الامتحانات والاختبارات</h3>
                    <p className="text-sm text-white/80">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">المقالات والمحتوى</h3>
                    <p className="text-sm text-white/80">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">الخدمات الكنسية</h3>
                    <p className="text-sm text-white/80">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">الإشعارات اليومية</h3>
                    <p className="text-sm text-white/80">
        ...
        <Card className="backdrop-blur-md bg-white/20 dark:bg-black/20 shadow-lg">
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-2 text-white">كنيسة السيدة العذراء مريم بالاسماعيلية</h3>
                <p className="text-sm text-white/80 mb-4">
                  كنيسة أرثوذكسية قبطية
                </p>
                <div className="space-y-2">
                  <p className="text-white"><strong>الموقع:</strong> مصر</p>
                  <p className="text-white"><strong>التابعية:</strong> الكنيسة القبطية الأرثوذكسية</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="backdrop-blur-md bg-white/20 dark:bg-black/20 shadow-lg">
          ...
          <CardContent>
            <div className="text-center space-y-4">
              <div>
                <h3 className="font-semibold text-lg text-white">Peter Eshak Abdo</h3>
                <p className="text-white/80">مطور التطبيق</p>
              </div>
