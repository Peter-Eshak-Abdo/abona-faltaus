  ...
  const getBooks = (abbrevs: string[]) =>
    abbrevs
      .map((abbr) => {
        ...
        return { abbrev: abbr, name: (bookNames as Record<string, string>)[abbr] || book.name || abbr };
      })
