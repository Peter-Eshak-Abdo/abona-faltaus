...
```
Priority 2: 23 (المسابقة - الأهم للمستخدمين)
Priority 3: 15 (تحسينات)
Priority 4: 1, 16, 19 (تنظيف وتوثيق)
```
...
## الي تم الوصول اليه
# متبقي
1. عايز Test كامل زيUnit اعملي ملفين او تلاتة كل واحد يختبر المشروع كامل لو فيه اي مشكلة وانا هبقي اشغلهم
واسم المستخدم عادي
14. لما يدوس علي زرار اضافة الي اليوم بيظهر SelectionToolbar لايزم يبقي شكةواضح اكتر ولما يضيف الاية يكتبلة تم الاضافة بنجاح الي اجتماع (اسم الاجتماع) وتتقفل الdialog عادي
15. في صفحة الكتاب المقدس لما اختار آية في SelectionToolbar تضيف زرار تفسير فيودية لصفحة شات بوت /chat ويكون حاطط الآية في البرمب المستخدم وقبلية كلمة تفسير
16. في صحة المقالات بعد ما كتبت مقال جابلي رسالة تم ارسال المقال بنجاح وبعد كده مظهرش اي حاجة عايزك تتأكد من api والباك اند
19. اشغل صفحة review واشغل الادمن الي هو بالايميل والي هيبقي انا يعني الناس تقدر تضيف review وكده كده فيه ادمن هو الي يشوفهم كلهم والحساب الادمن ده هو انا حاليا
