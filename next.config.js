      ...
      // ===== Global Security Headers =====
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https: blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: blob: https:; media-src 'self' data: blob: https:; connect-src 'self' https: wss:; frame-ancestors 'none';",
          },
        ],
      },
      // ===== صور: كاش طويل =====
    ...
    if (!isServer) {
      ...
      config.plugins.push(
        new webpack.NormalModuleReplacementPlugin(
          /^node:(fs|https|http|stream|path|crypto|os)$/,
          (resource) => {
